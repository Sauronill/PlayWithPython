<template>
    <div>
        ...
        -->
         <div class="container-search">
            <div class="handle-box">
                ...
                <el-input v-model="form.name" placeholder="请输入品牌" class="mr10"></el-input>
        ...
        <!-- Add弹出框 -->
        <el-dialog title="添加品牌" :visible.sync="addVisible" width="20%" :show-close="visable">
        ...
        <!-- Read弹出框 -->
        <el-dialog title="查看品牌" :visible.sync="readVisible" width="20%" :show-close="visable">
        ...
        <!-- Edit弹出框 -->
        <el-dialog title="编辑品牌" :visible.sync="editVisible" width="20%" :show-close="visable">
            <el-form ref="form" :model="form" label-width="100px">
                <el-form-item>
                    <span slot="label">
                        <span class="must">*</span>
...
<script>
import { fetchData } from '../../../api/vehicle_brand';
export default {
    name: 'basetable',
    data() {
        return {
